...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2025 at 07:04 PM
...
(2, 'Algem', 'algem', 'algem123', 'instructor', '2025-05-21 11:05:53'),
(5, 'jhonemar', 'jhonemar', '1234', 'instructor', '2025-05-21 11:26:07');
...
(12, 'CSM204', 'BS Computer Science', '2nd Year', '2nd Semester', 3, 'CL2', '13:00:00', '14:30:00', 'Tuesday, Friday, Saturday', 5, 145);
...
--
ALTER TABLE `student_subject`
  MODIFY `ss_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `subj_avail`
  MODIFY `sub_avail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
